    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                MemoriaTrabajoPanel memoriaTrabajoPanel=jFramePrueba.memoriaTrabajoPanel2;
                MemoriaTrabajoPanelController memoriaTrabajoPanelController= new MemoriaTrabajoPanelController(memoriaTrabajoPanel);
                memoriaTrabajoPanelController.mostrarHortaliza("Papa");
